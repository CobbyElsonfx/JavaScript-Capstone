...
const renderMovies = async (data) => {
  ...
  movie.id
}" placeholder="Type comment"  rows="5" required></textarea>
           </fieldset> 
         ...
         <div>m
           ...
           <fieldset>
            <div>
              ...
              <input type="text"  placeholder="name" id="username-${movie.id}" name="username" required>
            </div>
            <div>
              <label for="date_start"></label>
              <input type="date" id="date_start-${movie.id}" name="date_start"  required>
           </div>
           <div>
           <input type="date" id="date_end-${movie.id}" name="date_end"  required>
